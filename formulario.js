...
//BASE DE DATOS
var productos = ["Frasco de moringa en capsulas", "Jabon de moringa", "Aceite de moringa 5onz", "Frasco de moringa pulverizada", "Crema Facial de Noche","Crema facial de día" , "Shampoo Natural de Moringa"];
var imgGrandes = ["frasco.png", "jabon.png", "Screenshot_20240721_215854.png", "moringa.png", "cremanoche.png", "cremadia.png", "shampoo.png"];
var imgPeque = ["fra.png", "ja.png", "Screen.png", "mor.png", "creman.png", "cremad.png", "sha.png"];
var precios = [85, 45, 185, 165, 250, 250, 55,];
var stock = [10, 10, 10, 10, 10, 10, 10,10];
...
window.onload = function(){
    ...
    //Se cargan los productos dentro del HTML de forma dinamica haciendo uso de los datos de la base de datos, como si de un PHP se tratase:
    var DIVS = document.getElementsByName("DIVS");
    for (i in productos){
        DIVS[i].innerHTML = '<a id="imgG'+i+'" href="' +imgGrandes[i]+ '"><img id="imgP'+i+'" class="imagen" src="' +imgPeque[i]+ '"></a><div class="etiquetas"><b><span id="pro'+i+'">' +productos[i]+ '</span>: <span id="pre'+i+'">' +precios[i]+ 'Q</span></b></div><div class="stock">Hay en stock <span id="uni'+i+'">' +stock[i]+ '</span> unidades,<br/>¿Cuantas quiere?: <input class="uniBien" type="number" id="uniUser'+i+'" name="uniUser" value="0" size="4" /></div>';
    }
...
/**/			document.getElementById("divPago").className = "divsNo";				
    ...
    document.getElementById("tablaTotal").innerHTML = tablaTotal + '<tr><td> </td> <td></td><td class="preUni"><b>Transporte: </b></td><td class="preTotal"><b>' +totalTransporte+ '</b></td></tr>' + '<tr><td> </td> <td></td><td class="preUni"><b>IVA ('+(IVA*100)+'%): </b></td><td class="preTotal"><b>' +totalIVA+ '</b></td></tr>' + '<tr><td> </td> <td></td><td class="preUni"><b>Total: </b></td><td class="preTotal" id="totalAPagar"><b>' +totalAPagar+ ' Q</b></td></tr>';
}	
